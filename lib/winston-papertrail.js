 ...
 * @type {Function}
 */
var Papertrail = exports.Papertrail = class extends Transport {
    constructor(options){
      super(options);
      var self = this;
 ...
 * @param {object}      info      The object that Winston v3.0 sends that contains:
 *  @param {String}        info.level    Level at which to log the message.
 *  @param {String}        info.message        Message to log
 *  @param {String|object|Function}        [info.meta]    Optional metadata to attach
...
Papertrail.prototype.log = function (info, callback) {
    ...
    this.sendMessage(this.hostname, this.program, info[LEVEL], output, callback);
